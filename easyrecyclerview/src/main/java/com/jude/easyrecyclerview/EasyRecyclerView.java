...
public class EasyRecyclerView extends FrameLayout {
	...
	private void initView() {
		...
		mPtrLayout.setColorSchemeResources(R.color.refresh_default_color);
	...
	private static class EasyDataObserver extends AdapterDataObserver {
		...
		public EasyDataObserver(EasyRecyclerView recyclerView, boolean hasProgress, boolean headerPrior) {
	...
	public void setAdapter(RecyclerView.Adapter adapter) {
		...
		adapter.registerAdapterDataObserver(new EasyDataObserver(this, false, headerPrior));
	...
	public void setAdapterWithProgress(RecyclerView.Adapter adapter) {
		mRecycler.setAdapter(adapter);
		adapter.registerAdapterDataObserver(new EasyDataObserver(this, true, headerPrior));
		adapter.notifyDataSetChanged();
	}
	...
	public void setRefreshingImmediately(final boolean isRefreshing) {
		mPtrLayout.setRefreshing(isRefreshing);
	}
