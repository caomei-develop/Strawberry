...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
	...
	public DividerGridItemDecoration(Context context, int[] dividerProviders) {
		if (dividerProviders != null && dividerProviders.length > 0) {
			dividerIds = dividerProviders;
			if (dividerProviders.length == 1) {
