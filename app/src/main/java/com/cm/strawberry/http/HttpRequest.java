package com.cm.strawberry.http;
        ...
        setSubscriber(observable, new Subscriber<T>() {
            ...
            public void onError(Throwable error) {
                ...
                if(error!=null && resultListener!=null){
                    ...
                    Toast.makeText(StrawberryApplication.getContext(),"网络不给力", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if(code>=300&&code<500){
                    Toast.makeText(StrawberryApplication.getContext(),"您的请求迷路了，请稍后再试", Toast.LENGTH_LONG).show();
                }else if(code>=500){
                    Toast.makeText(StrawberryApplication.getContext(),"服务器异常，请稍后再试", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(StrawberryApplication.getContext(),"网络不给力", Toast.LENGTH_LONG).show();
                }
            }
