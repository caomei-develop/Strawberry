...
public class GradualPopupWindow {
    ...
    private void init() {
        ...
        popupWindow.setAnimationStyle(R.style.popu_bag);
    ...
    public void show(final View parent, int gravity, int x, int y) {
        if (popupWindow != null && contentView != null && !isBusy) {
            ...
            RelativeLayout.LayoutParams contentLayoutParams = (LayoutParams) userView.getLayoutParams();
    ...
    public void showDown(final View parent, int gravity, int x, int y, int topMargin) {
        if (popupWindow != null && contentView != null && !isBusy) {
            if (gravity == Gravity.NO_GRAVITY) {
                gravity = Gravity.TOP | Gravity.RIGHT;
            }
            RelativeLayout.LayoutParams contentLayoutParams = (RelativeLayout.LayoutParams) userView.getLayoutParams();
            if (contentLayoutParams == null) {
                contentLayoutParams = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT,
            ...
            userView.setLayoutParams(contentLayoutParams);
            if (inAni != null) {
                inAni.setAnimationListener(new Animation.AnimationListener() {
            ...
            if (android.os.Build.VERSION.SDK_INT >= 24 && topMargin != 0) {
                popupWindow.setHeight(popupWindow.getHeight() - (processed ? 0 : topMargin));
                popupWindow.showAsDropDown(parent, x, 0, gravity);
                popupWindow.update();
            } else {
