...
public class StringUtil {
    ...
    /**
     * convert userAgent credit log's address
     *
     * @param address
     * @return
     */
    ...
    public static String currencyFormat(int credit) {
        ...
        return StringUtil.creditFormat(nf.format(credit / 10000.00f));
    }


    public static String coinFormat(int credit) {
        NumberFormat nf = NumberFormat.getInstance();
        return nf.format(credit);
    }

    public static String currencyFormat(int credit, int floatDigit) {
        NumberFormat nf = NumberFormat.getInstance();
        return StringUtil.creditFormat(nf.format(credit / 10000.00f), floatDigit);
    }


    public static String currencyRmbFormat(int credit) {
        NumberFormat nf = NumberFormat.getInstance();
        return StringUtil.creditFormat(nf.format(credit / 100f), 2);
    }
