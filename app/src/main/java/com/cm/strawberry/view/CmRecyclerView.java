...
import com.cm.strawberry.adapter.CmAdapter;
...
public class CmRecyclerView extends RecyclerView{
    ...
    public CmRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public CmRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    public void setAdapter(Adapter adapter) {
        ...
        View refreshView = LayoutInflater.from(getContext()).inflate(R.layout.cm_refresh, null);
        ...
        cmAdapter = new CmAdapter(adapter, headers, footers);
        super.setAdapter(cmAdapter);
    }
